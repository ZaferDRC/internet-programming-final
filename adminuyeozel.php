...
<body>
    ...
    if (isset($_POST["kaydet"])) {
        ...
        $icerik = $_POST["icerik"];
        $sorgu = $baglandb->query("DELETE FROM uyeozel");
        $sorgu = $baglandb->query("INSERT INTO uyeozel (icerik) VALUES('$icerik')");

        if ($sorgu) {

            echo "<script>window.location.href='adminuyeozel.php';</script>";
        } else {
