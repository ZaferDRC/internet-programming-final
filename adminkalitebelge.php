...
<body>
    ...
    if (isset($_POST["kaydet"])) {
        ...
        $icerik = $_POST["icerik"];
        $sorgu = $baglandb->query("DELETE FROM kalitebelge");
        $sorgu = $baglandb->query("INSERT INTO kalitebelge (icerik) VALUES('$icerik')");

        if ($sorgu) {

            echo "<script>window.location.href='adminkalitebelge.php';</script>";
        } else {
    ...
    <form action="" method="POST">
        <h1 style="font-size: x-large; color:#fff;">KALİTE BELGE İÇERİK</h1>
